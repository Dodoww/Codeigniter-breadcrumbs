...
class Breadcrumbs {
    ...
    function push($page, $href, $icon = "")
    {
        ...
        // push breadcrumb
        $this->breadcrumbs[$href] = array('page' => $page, 'href' => $href, 'icon' => $icon);
    }
        ...
        if ($this->breadcrumbs) {
            ...
            foreach ($this->breadcrumbs as $key => $crumb) {
                ...
                if (end($keys) == $key) {
                    ...
                    if (!empty($crumb['icon']))
                        $output .= $this->crumb_open.'<a href="' . $crumb['href'] . '"><i class="fa fa-' . $crumb['icon'] .'"></i>' . $crumb['page'] . '</a> '.$this->crumb_divider.$this->crumb_close;
                    else
